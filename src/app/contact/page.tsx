              ...
              <div className="mt-8 space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href={`tel:${siteConfig.phone}`} className="font-bold text-white transition hover:text-[#c5a059]" dir="ltr">
                      {siteConfig.phone}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a 
                      ...
                      className="font-bold text-white transition hover:text-[#c5a059]"
                      dir="ltr"
                    >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${siteConfig.email}`} className="font-bold text-white transition hover:text-[#c5a059]">
                      {siteConfig.email}
                    </a>
                  </div>
                </div>

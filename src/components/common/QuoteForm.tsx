...
- ملاحظات: ${notes || 'لا يوجد'}`
  ...
  if (isSubmitted) {
    return (
      <div className="rounded-xl bg-green-50 p-6 text-center text-green-800 ring-1 ring-green-200">
        <CheckCircle2 className="mx-auto h-10 w-10 text-green-600" />
        <h4 className="mt-2 font-bold">تم إرسال طلبك بنجاح!</h4>
        <p className="mt-1 text-xs text-green-700">
          تم فتح محادثة الواتساب المباشرة مع خدمة العملاء لخدمتك فوراً.
        </p>
      </div>
    )
  }
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <input
          ...
          className="mt-1 w-full rounded-xl border border-gray-200 px-3.5 py-2.5 text-sm outline-none transition focus:border-[#c5a059]"
        />
      </div>
      ...
      <button
        type="submit"
        className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#1a233a] py-3 text-sm font-bold text-[#c5a059] shadow-md transition hover:bg-[#1a233a]/90"
      >

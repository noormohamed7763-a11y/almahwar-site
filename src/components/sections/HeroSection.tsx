    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-[#0e1424] via-[#162035] to-[#0f172a] py-14 text-white lg:py-20" dir="rtl">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-12">
          ...
          {/* الجانب الأيمن: النصوص وأزرار التواصل */}
          <div className="text-right lg:col-span-6">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <Link
                href="/projects"
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-l from-[#c5a059] to-[#d9b87a] px-7 py-3.5 text-sm font-bold text-[#1a233a] shadow-lg shadow-[#c5a059]/20 transition duration-200 hover:brightness-105 active:scale-95"
              >
          ...
          {/* الجانب الأيسر: شبكة الصور الأربع المنظمة (Staggered Grid) */}
          <div className="relative lg:col-span-6">
            <div className="grid grid-cols-2 gap-4 sm:gap-5">
              ...
              {/* العمود الثاني - مزاح للأسفل بتناغم معماري */}
